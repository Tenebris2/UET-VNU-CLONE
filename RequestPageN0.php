    ...
    <div class="main-container">
        ...
        <div class="big-label-container">
            <div class="big-label">
                ...
                <h1><b>Dịch vụ gửi yêu cầu của trường Đại học Công nghệ!
<br>Hãy chọn yêu cầu từ menu bên trái</b></h1>
                </div>
                <div class="small-label-2">
                    <p>
                    <b>
                    Chú ý: Các yêu cầu đã được hệ thống ghi nhận sẽ không thể chỉnh sửa.
                     Sinh viên/Học viên/NCS cần kiểm tra thật kỹ những yêu cầu của mình trước ghi nhận và gửi đến phòng chức năng của Trường 
                     <br>
                     Đại học Công nghệ. Sinh viên/Học viên/NCS phải chịu trách nhiệm và tuân theo những quy định đã đề ra của Trường Đại học Công nghệ.
                    </b>             
                    </p>
                </div>
            </div>
